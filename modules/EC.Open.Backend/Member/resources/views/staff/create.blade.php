...
{{--@section ('breadcrumbs')--}}
    ...
    {{--<ol class="breadcrumb">--}}
        ...
        {{--<li class="active">{!! link_to_route('admin.staff.create', '创建员工') !!}</li>--}}
    {{--</ol>--}}
{{--@stop--}}
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content" style="display: block;">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {!! Form::text('staff_id',null, ['class' => 'form-control', 'placeholder' => '']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group date form_datetime">
                    ...
                    <input type="text" class="form-control inline" name="hiredate_at" value="{{date("Y-m-d",time())}}"
