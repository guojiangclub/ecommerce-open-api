...
@section('body')
    <div class="row">
        ...
        <form method="POST" action="{{route('admin.RoleManagement.role.importUser.saveImport')}}" accept-charset="UTF-8"
            ...
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <a no-pjax href="{{url('/assets/template/role_user_import.xlsx')}}" target="_self">会员导入模板下载</a>
                    </div>
                </div>
