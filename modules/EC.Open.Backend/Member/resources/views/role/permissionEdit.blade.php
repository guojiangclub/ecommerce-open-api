...
{{--@section('content')--}}
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content" style="display: block;">
            {!! Form::model($model, ['url' => route('admin.RoleManagement.permission.update', $model->id), 'class' => 'form-horizontal',
            'role' => 'form', 'method' => 'PATCH','id'=>'create-permissionManagement-form']) !!}
