...
{{--@section ('breadcrumbs')--}}
    {{--<h2>创建权限</h2>--}}
    {{--<ol class="breadcrumb">--}}
        {{--<li><a href="{!!route('admin.RoleManagement.role.index')!!}"><i class="fa fa-dashboard"></i> 权限管理</a></li>--}}
...
{{--@section('content')--}}
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content" style="display: block;">
            {!! Form::open(['route' => 'admin.RoleManagement.permission.store', 'class' => 'form-horizontal',
            'role' => 'form', 'method' => 'post','id'=>'create-permissionManagement-form']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    ...
                    <a href="{{route('admin.RoleManagement.permission.index')}}" class="btn btn-danger">取消</a>
                </div>
            </div>
...
<script>
    $('#create-permissionManagement-form').ajaxForm({
