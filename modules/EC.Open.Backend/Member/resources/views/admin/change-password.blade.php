...
{{--@section ('breadcrumbs')--}}
    ...
    {{--<ol class="breadcrumb">--}}
        ...
        {{--<li>{!! link_to_route('admin.manager.edit', "编辑 ".$user->name, $user->id) !!}</li>--}}
        {{--<li class="active">{!! link_to_route('admin.manager.changePassword', '更改密码', $user->id) !!}</li>--}}
    {{--</ol>--}}
...
{{--@section('content')--}}
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content" style="display: block;">
            {!! Form::open(['route' => ['admin.manager.updatePassword', $user->id],
