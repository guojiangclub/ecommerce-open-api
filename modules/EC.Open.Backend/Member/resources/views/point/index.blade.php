...
{{--@section ('breadcrumbs')--}}
    ...
    {{--<ol class="breadcrumb">--}}
        ...
        {{--<li class="active">{!! link_to_route('admin.users.pointlist', '会员积分管理') !!}</li>--}}
        {{--<li class="active">{!! link_to_route('admin.users.pointlist', '积分记录') !!}</li>--}}
    ...
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            ...
            <a  id="chapter-create-btn" data-toggle="modal"
                ...
                data-url="{{route('admin.member.points.importPointModal')}}"
                class="btn btn-primary pull-right  " style="margin-right: 5px">批量导入积分</a>
        </ul>
