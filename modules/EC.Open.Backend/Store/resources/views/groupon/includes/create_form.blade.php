{!! Form::open( [ 'url' => [route('admin.promotion.groupon.store')], 'method' => 'POST', 'id' => 'base-form','class'=>'form-horizontal'] ) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" name="base[auto_close]" placeholder="" value="5"/>
    </div>
</div>
