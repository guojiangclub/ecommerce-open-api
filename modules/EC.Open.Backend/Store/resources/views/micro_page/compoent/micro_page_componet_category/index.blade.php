        ...
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                ...
                <div class="row" style="margin-bottom:20px;">
                    ...
                    <div class="col-sm-4">
                        <a target="_blank" href="{{route('admin.setting.micro.page.compoent.create',['type'=>$type,'header'=>'分类商品'])}}" class="btn btn-w-m btn-info">创建分类商品模块</a>
                    </div>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th class="col-sm-2">显示数量</th>
                        <th class="col-sm-2">显示名称</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @foreach($item->item as $key=> $citem)
                                        ...
                                        @if($citem->associate)
                                            ...
                                            <div>
                                                 分类{{$key+1}}:
                                                <a href="{{route('admin.category.edit',$citem->associate->id)}}" target="_blank">
                                                 {{$citem->associate->name}}
                                                </a>
                                            </div>
                                ...
                                <td>
                                    <a
                                            ...
                                            href="{{route('admin.setting.micro.page.compoent.edit',['type'=>$type,'code'=>$item->code,'header'=>'分类商品'])}}">
