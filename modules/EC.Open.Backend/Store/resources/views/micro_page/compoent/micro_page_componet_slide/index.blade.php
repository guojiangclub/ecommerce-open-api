        ...
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                ...
                <div class="row" style="margin-bottom:20px;">
                    ...
                    <div class="col-sm-4">
                        <a target="_blank" href="{{route('admin.setting.micro.page.compoent.create',['type'=>$type,'header'=>'幻灯片'])}}" class="btn btn-w-m btn-info">创建幻灯片模块</a>
                    </div>
                            ...
                            <tr>
                                    ...
                                    @if($item->item->count())
                                        ...
                                        @foreach($item->item as $citem)
                                            ...
                                            <a href="{{$citem->image}}" target="_blank">
                                                 <div style="margin-bottom:10px;background:url('{{$citem->image}}') no-repeat;background-size: cover;height: 100px;">
                                ...
                                <td>
                                    <a
                                            ...
                                            href="{{route('admin.setting.micro.page.compoent.edit',['type'=>$type,'code'=>$item->code,'header'=>'幻灯片'])}}">
