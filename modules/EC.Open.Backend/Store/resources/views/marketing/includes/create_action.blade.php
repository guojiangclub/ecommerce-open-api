...
<div class="form-group">
    <label class="col-sm-2 control-label">
        <input type="checkbox" name="action[1][type]"
               value="point" class="switch-input"> 赠送积分：
    </label>
    <div class="col-sm-10">
        <input type="text" style="display: none" name="action[1][value]" class="sw-value form-control" placeholder="分">
    </div>
</div>

<div class="form-group">
    <label class="col-sm-2 control-label">
        <input type="checkbox" name="action[2][type]"
               value="coupon" class="switch-input"> 赠送优惠券：
    </label>
    <div class="col-sm-10 sw-value" style="display: none" >
