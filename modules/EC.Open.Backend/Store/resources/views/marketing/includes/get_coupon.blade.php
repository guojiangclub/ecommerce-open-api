    ...
    <div class="row">
        <div class="col-md-12 clearfix">
            ...
            <div class="col-sm-7">
                ...
                <input type="hidden" id="temp_select_coupons">
            </div>
        </div>
...
@section('footer')
    ...
    <script>
        var postUrl = '{{route('admin.marketing.getCouponData')}}';
        ...
        function getList() {
            $('.pages').pages({
                ...
                $('.page-coupons-list').html(html);
            });
        }

        $(document).ready(function () {
            $('#temp_select_coupons').val($('#select_coupons').val());
            paraDiscount.ids = $('#temp_select_coupons').val();
