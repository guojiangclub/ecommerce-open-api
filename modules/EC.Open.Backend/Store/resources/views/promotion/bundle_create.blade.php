        ...
        <div class="ibox-content" style="display: block;">
            <div class="row">
                ...
                <div class="panel-body">
                    {!! Form::open( [ 'url' => [route('admin.promotion.bundle.store')], 'method' => 'POST', 'id' => 'create-discount-form','class'=>'form-horizontal'] ) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <table class="table table-bordered" id="discount-table">
                                ...
                                <tbody>
                                <tr class="showData">
                                    <td> <select name="items[0][type]" style="height: 34px;">
                                            <option value="sku">SKU</option>
                                            <option value="spu">SPU</option>
                                        </select></td>
                                    <td> <input type="text" name="items[0][item_id]" class="form-control" value="" required="required"></td>
                                    <td> <input type="text" name="items[0][quantity]" class="form-control" value="" required="required"></td>
                                    <td> <input type="text" name="items[0][original_price]" class="form-control" value="" disabled="disabled"></td>
                                    <td> <input type="text" name="items[0][bundle_price]" class="form-control" value="" required="required"></td>
