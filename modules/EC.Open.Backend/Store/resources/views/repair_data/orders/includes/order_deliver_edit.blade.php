        ...
        <form method="POST" action="{{route('admin.orders.savedeliver')}}" accept-charset="UTF-8"
            ...
            <div class="col-md-8">
                    ...
                    <div class="col-sm-9">
                        ...
                        @if($freightCompany->count()>0)
                            <select class="form-control" name="method_id" id="shopping">
                                ...
                                <option value="{{$item->id}}" type="{{$item->code}}" @if($item->id==$shipping->method_id) selected @endif>{{$item->name}}</option>
                                @endforeach
                            </select>
                        @endif
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="tracking" value="{{$shipping->tracking}}"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                            <div class="date form_datetime">
                                <input type="text" class="form-control" name="delivery_time" value="{{$shipping->delivery_time}}"     placeholder="" readonly>
