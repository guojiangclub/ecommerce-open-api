...
@section ('breadcrumbs')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{!! link_to_route('admin.users.banned', '已禁用会员') !!}</li>
    </ol>
...
@section('content')
    ...
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            <li class="{{ Active::pattern('admin/users') }}"><a href="{{route('admin.users.index')}}"
                                                                aria-expanded="true">
                    会员列表</a></li>
            <li class="{{ Active::pattern('admin/users/banned') }}"><a data-toggle="tab" href="#tab-3">禁用的会员</a>
            </li>
            <li class="{{ Active::pattern('admin/users/deleted') }}"><a
                        href="{{route('admin.users.deleted')}}">删除的会员</a></li>
