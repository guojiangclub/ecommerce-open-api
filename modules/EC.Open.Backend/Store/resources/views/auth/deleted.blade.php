...
@section('content')
    <div class="tabs-container">
        <ul class="nav nav-tabs">
            <li class="{{ Active::pattern('admin/users') }}"><a href="{{route('admin.users.index')}}" aria-expanded="true">
                    会员列表</a></li>
            <li class="{{ Active::pattern('admin/users/banned') }}"><a href="{{route('admin.users.banned')}}">禁用的会员</a>
            </li>
