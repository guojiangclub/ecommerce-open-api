...
@section('content')--}}
    <div class="tabs-container">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class=""><a no-pjax href="{{route('admin.promotion.gift.birthday.user')}}" aria-expanded="true"> 即将生日用户列表</a></li>
        </ul>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            <span  class="btn btn-xs btn-danger del-suit" data-url="{{route('admin.promotion.gift.birthday.delete',['id'=>$item->id])}}">
