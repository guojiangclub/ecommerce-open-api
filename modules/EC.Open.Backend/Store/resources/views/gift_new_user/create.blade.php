        ...
        <div class="tab-content">
            <div id="tab-1" class="tab-pane active">
                <div class="panel-body">
                    <div class="row">
                        {!! Form::open( [ 'url' => [route('admin.promotion.gift.new.user.store')], 'method' => 'POST', 'id' => 'create-suit-form','class'=>'form-horizontal'] ) !!}
                            ...
                            <div class="col-sm-3">
                                ...
                                ">
                                        <span class="input-group-addon" style="cursor: pointer">
                                            ...
                                            <input type="text" class="form-control inline" name="starts_at" value="{{empty($s_time)?date("Y-m-d H:i:s",time()):$s_time}}"
                            ...
                            <div class="col-sm-3">
                                <div class="input-group date form_datetime">
                                    ...
                                    <input type="text" class="form-control" name="ends_at"
                                           value="{{empty($s_time)?date("Y-m-d H:i:s",time()+60*60*24*30):$e_time}}" placeholder="点击选择结束时间" readonly>
                                    <span class="add-on"><i class="icon-th"></i></span>
                                </div>
                            </div>
                        </div>
