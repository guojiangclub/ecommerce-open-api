...
@section ('breadcrumbs')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">批量导入线下优惠券数据</li>
    </ol>
        ...
        <div class="ibox-content" style="display: block;">
            <div class="nav-tabs-custom">
                <div class="tab-content div_1">
                    {!! Form::open( [ 'url' => [route('admin.dataimport.importCoupon')], 'method' => 'POST','id' => 'base-form','class'=>'form-horizontal'] ) !!}

                    <div class="tab-pane active" id="tab_1">
                        <div class="form-group">
                            {!! Form::label('name','批量导入线下优惠券数据：', ['class' => 'col-lg-4 control-label']) !!}
                            <div class="col-lg-8">
