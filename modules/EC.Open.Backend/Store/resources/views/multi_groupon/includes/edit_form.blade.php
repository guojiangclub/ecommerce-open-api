...
<div class="form-group" id="two-inputs">
    ...
    <div class="col-sm-4">
        <div class="input-group date form_datetime">
            ...
            <input type="text" name="starts_at" class="form-control inline" id="date-range200" size="20" value="{{$groupon->starts_at}}"
    ...
    <div class="col-sm-4">
        <div class="input-group date form_datetime">
            ...
            <input type="text" name="ends_at" class="form-control inline" id="date-range201" size="20" value="{{$groupon->ends_at}}"
